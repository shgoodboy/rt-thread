...
#ifdef BSP_USING_ESP32_SDIO
void imxrt_esp32_sdio_pins_init(void)
{
    CLOCK_EnableClock(kCLOCK_Iomuxc);           /* LPCG on: LPCG is ON. */

    /* Configure USDHC2 pins for ESP32 SDIO communication */
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_SD_B2_00_USDHC2_CMD,        /* GPIO_SD_B2_00 is configured as USDHC2_CMD */
        1U);                                    /* Software Input On Field: Force input path */
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_SD_B2_01_USDHC2_CLK,        /* GPIO_SD_B2_01 is configured as USDHC2_CLK */
        1U);                                    /* Software Input On Field: Force input path */
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_SD_B2_02_USDHC2_DATA0,      /* GPIO_SD_B2_02 is configured as USDHC2_DATA0 */
        1U);                                    /* Software Input On Field: Force input path */
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_SD_B2_03_USDHC2_DATA1,      /* GPIO_SD_B2_03 is configured as USDHC2_DATA1 */
        1U);                                    /* Software Input On Field: Force input path */
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_SD_B2_04_USDHC2_DATA2,      /* GPIO_SD_B2_04 is configured as USDHC2_DATA2 */
        1U);                                    /* Software Input On Field: Force input path */
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_SD_B2_05_USDHC2_DATA3,      /* GPIO_SD_B2_05 is configured as USDHC2_DATA3 */
        1U);                                    /* Software Input On Field: Force input path */

    /* Configure ESP32 control pins */
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_AD_24_GPIO9_IO23,           /* ESP32 Reset pin */
        0U);
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_AD_25_GPIO9_IO24,           /* ESP32 Enable pin */
        0U);

    /* Set pin configurations for SDIO */
    IOMUXC_SetPinConfig(
        IOMUXC_GPIO_SD_B2_00_USDHC2_CMD,        /* CMD pin configuration */
        0x04U);                                 /* High drive strength, pullup enabled */
    IOMUXC_SetPinConfig(
        IOMUXC_GPIO_SD_B2_01_USDHC2_CLK,        /* CLK pin configuration */
        0x06U);                                 /* High drive strength, no pull */
    IOMUXC_SetPinConfig(
        IOMUXC_GPIO_SD_B2_02_USDHC2_DATA0,      /* DATA0 pin configuration */
        0x04U);                                 /* High drive strength, pullup enabled */
    IOMUXC_SetPinConfig(
        IOMUXC_GPIO_SD_B2_03_USDHC2_DATA1,      /* DATA1 pin configuration */
        0x04U);                                 /* High drive strength, pullup enabled */
    IOMUXC_SetPinConfig(
        IOMUXC_GPIO_SD_B2_04_USDHC2_DATA2,      /* DATA2 pin configuration */
        0x04U);                                 /* High drive strength, pullup enabled */
    IOMUXC_SetPinConfig(
        IOMUXC_GPIO_SD_B2_05_USDHC2_DATA3,      /* DATA3 pin configuration */
        0x04U);                                 /* High drive strength, pullup enabled */
    
    /* Configure control pins */
    IOMUXC_SetPinConfig(
        IOMUXC_GPIO_AD_24_GPIO9_IO23,           /* ESP32 Reset pin configuration */
        0x10B0U);                               /* Standard GPIO configuration */
    IOMUXC_SetPinConfig(
        IOMUXC_GPIO_AD_25_GPIO9_IO24,           /* ESP32 Enable pin configuration */
        0x10B0U);                               /* Standard GPIO configuration */

    /* Initialize control pins */
    gpio_pin_config_t esp32_pin_config = {
        kGPIO_DigitalOutput,
        1,
        kGPIO_NoIntmode
    };
    
    GPIO_PinInit(GPIO9, 23, &esp32_pin_config);  /* ESP32 Reset pin */
    GPIO_PinInit(GPIO9, 24, &esp32_pin_config);  /* ESP32 Enable pin */
}
#endif
